...
//
//    //用来只是item画出屏幕的方向，向左或者向有，用一枚举来标记
...
//    }
//
//    //分发事件，主要做的就是判断点击是那个Item,以及通过postDelayed来设置响应左右滑动事件
//
//
//    @Override
...
//                if (((Math.abs(getScrollvelocity)) > SNAP_VELOCITY) || (Math.abs(ev.getX() - downX) > mTouchSlop && Math
