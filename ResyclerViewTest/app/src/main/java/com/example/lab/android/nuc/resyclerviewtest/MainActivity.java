...
//                GridLayoutManager(MainActivity.this,4,GridLayoutManager.VERTICAL,true);

//        第一个参数为上下文环境，第二个显示列数，默认显示垂直布局
//        GridLayoutManager layoutManager1 = new
//                GridLayoutManager(MainActivity.this,3);
